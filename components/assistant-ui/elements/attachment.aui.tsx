...
const AttachmentPreviewDialog: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        bodyClassName="p-2"
        className="aui-attachment-preview-dialog-content [&>button]:bg-foreground/60 [&>button]:hover:bg-foreground/80 [&_svg]:text-background sm:max-w-3xl [&>button]:rounded-full [&>button]:p-1 [&>button]:opacity-100 [&>button]:ring-0!"
      >
        ...
        <AttachmentPreviewDialog>
          ...
          >
            ...
            {isUploading && (
              <div
                aria-hidden="true"
                className="aui-attachment-tile-uploading bg-background/60 animate-in fade-in-0 absolute inset-0 flex items-center justify-center backdrop-blur-[0.125rem] motion-reduce:animate-none"
              >
            ...
            {isError && (
              <div
                aria-hidden="true"
                className="aui-attachment-tile-error bg-background/70 animate-in fade-in-0 absolute inset-0 flex items-center justify-center backdrop-blur-[0.125rem] motion-reduce:animate-none"
              >
